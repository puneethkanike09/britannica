...
interface EditGradeModalProps {
    ...
    onGradeUpdated: (grade: { grade_id: string; title: string; description: string }) => void;
}
...
export default function EditGradeModal({ onClose, grade, onGradeUpdated }: EditGradeModalProps) {
    ...
    const validateForm = () => {
        ...
        if (!formData.title.trim()) {
            newErrors.title = 'Grade title is required';
            isValid = false;
                ...
                >
                    ...
                    >
                        ...
                        <div className="bg-white px-8 py-6 flex justify-between items-center flex-shrink-0">
                            <h2 className="text-3xl font-bold text-secondary">Edit Grade</h2>
                            <button
                                onClick={handleClose}
                            ...
                            <div className="space-y-6">
                                <div className="mb-3 relative">
                                    <label className="block text-textColor text-base mb-2">
                                        Grade Title<span className="text-red">*</span>
                                    </label>
                                    <input
                                        type="text"
                                        name="title"
