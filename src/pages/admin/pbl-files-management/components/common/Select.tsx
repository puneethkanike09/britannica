                    ...
                    {options.length === 0 ? (
                        ...
                        options.map((option) => (
                            <button
                                ...
                                className={`w-full px-4 text-lg font-bold py-2 text-left hover:bg-gray/10 text-textColor cursor-pointer break-words leading-tight ${value === option.value ? 'bg-gray/10' : ''
                                    }`}
                                role="option"
